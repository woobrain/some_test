...
# -*- 循环执行1
try:
    visual_block.Visual_Block_Info("循环执行1", 10, 0, "正在执行")
    ...
    while "1" == "1":
        ...
        try:
            ...
            rpa_c7be40_excel.get_sheet("").write("A" + str("2") + ":" + col_str + str(rpa_90fd4a), job_list)
        ...
        try:
            try:
                ...
                try:
                    ...
                    sleep(0)
                    rpa_0d164f_webpage.add_element("rpa_1167b1", id="", css="",
                                                   xpath=['//*[@id="resultList"]/div[55]/div/div/div/ul',
                                                          '/html/body/div[2]/div[4]/div[55]/div/div/div/ul'], frame=[])
                    rpa_0d164f_webpage.switch_to_frame_by_path([])
                ...
                try:
                    ...
                    rpa_35b5c7_webelement = rpa_cb1a9b_webelement.children(index=0)
                    sleep(0)
                ...
                try:
                    ...
                    sleep(0)
                    rpa_0d164f_webpage.switch_to_frame_by_path(rpa_cb1a9b_webelement.frame)
                    rpa_bc0774_string = rpa_cb1a9b_webelement.get_attr("href")
                    sleep(0)
                ...
                try:
                    ...
                    log.info("[%s] %s", "打印日志", rpa_bc0774_string)
    ...
    visual_block.Visual_Block_Info("循环执行1", 10, 2, e)
